...
export default function PickerContextWrapper({ value, children, onChange, squareWidth, hideOpacity, squareHeight, defaultStyles, }: PCWProps): import("react/jsx-runtime").JSX.Element;
